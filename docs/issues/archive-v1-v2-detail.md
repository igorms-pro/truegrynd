# Archive — détail livré V1 / V2

> **Figé juin 2026.** Toutes les sections ci-dessous sont **🟢 mergées sur `main`**.  
> Tracker actif : [issues.md](./issues.md) · Stratégie V2 : [V2_STRATEGY.md](../V2_STRATEGY.md)
