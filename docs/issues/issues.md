...
- [ ] **V2-07** — Rival Matches (1v1 / petits groupes) — 🟡 [#85](https://github.com/igorms-pro/truegrynd/issues/85) · PR1 [#86](https://github.com/igorms-pro/truegrynd/pull/86) PR2 [#87](https://github.com/igorms-pro/truegrynd/pull/87) · PR3 `feature/issue-85-v2-07-rival-play`
...
**GitHub :** [#85](https://github.com/igorms-pro/truegrynd/issues/85) · **Branche :** `feature/issue-85-v2-07-rival-play` · **Statut :** 🟡 · PR1 [#86](https://github.com/igorms-pro/truegrynd/pull/86) + PR2 [#87](https://github.com/igorms-pro/truegrynd/pull/87) mergés
...
- [ ] **UX** : créer, accepter, soumettre, résultat — PR2 [#87](https://github.com/igorms-pro/truegrynd/pull/87) create/invite mergé · PR3 play 🟡 `feature/issue-85-v2-07-rival-play`
- [ ] **Notifications** : minimal V2 (email/toast/polling), pas besoin d'un réseau social complet — polling PR3
...
| **V2 — Accessible competition**               | 🟢 V2-00–06 · **🟡 V2-07** [#85](https://github.com/igorms-pro/truegrynd/issues/85) PR1 [#86](https://github.com/igorms-pro/truegrynd/pull/86) PR2 [#87](https://github.com/igorms-pro/truegrynd/pull/87) · `feature/issue-85-v2-07-rival-play` (PR3) |
| **QA V1**                                     | 🟢 GO (juin 2026) — périmètre critique testé                                                                                                                                                                                                          |

**Suite produit :** **V2-07** 🟡 ([#85](https://github.com/igorms-pro/truegrynd/issues/85) · PR1 [#86](https://github.com/igorms-pro/truegrynd/pull/86) + PR2 [#87](https://github.com/igorms-pro/truegrynd/pull/87) mergés · PR3 play 🟡 `feature/issue-85-v2-07-rival-play`). QA V2 globale en fin de lot V2, pas issue par issue.
