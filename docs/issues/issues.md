...
- [ ] **V2-10** — Proof Levels (Honor / Video / Community / Judge / Event) — 🟡 [#95](https://github.com/igorms-pro/truegrynd/issues/95) · `feature/issue-95-proof-levels`
...
| **V2-10 — Proof levels**                      | 🟡 [#95](https://github.com/igorms-pro/truegrynd/issues/95) · branche `feature/issue-95-proof-levels` · migration **`027`** prod                                                                                                                    |
