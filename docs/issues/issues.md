...
**Statut :** 🟢 **LIVRÉ** — [#90](https://github.com/igorms-pro/truegrynd/issues/90) fermée · PR [#91](https://github.com/igorms-pro/truegrynd/pull/91) mergée `main` · migration **`023`** (à appliquer prod)
...
- [ ] **Finisher Card** : “I scored for Horde Rookie” (reporté V2-11 growth / polish).
...
| **V2 — Accessible competition**               | 🟢 V2-00–06 · **🟡 V2-07** [#85](https://github.com/igorms-pro/truegrynd/issues/85) PR4 [#89](https://github.com/igorms-pro/truegrynd/pull/89) · 🟢 **V2-08** [#90](https://github.com/igorms-pro/truegrynd/issues/90) PR [#91](https://github.com/igorms-pro/truegrynd/pull/91) · migration **`023`** prod |
| **QA V1**                                     | 🟢 GO (juin 2026) — périmètre critique testé                                                                                                                                                                                                                                                                |

**Suite produit :** merger **PR4** [#89](https://github.com/igorms-pro/truegrynd/pull/89) → clôturer **V2-07** [#85](https://github.com/igorms-pro/truegrynd/issues/85) · **V2-09** Micro-events async · appliquer migration **`023`** prod (V2-08). QA V2 globale en fin de lot V2.
