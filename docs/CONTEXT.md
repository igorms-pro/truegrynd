...
Le suivi détaillé du MVP a été retiré du repo (MVP considéré livré). **Backlog post-MVP + vision “produit killer”** : **[docs/issues/issues.md](./issues/issues.md)**. Conventions : **[docs/issues/README.md](./issues/README.md)**.
