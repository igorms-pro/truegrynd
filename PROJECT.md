...
- **[docs/issues/issues.md](./docs/issues/issues.md)** – Backlog **post-MVP** (admin UGC, streaks, respect, referral, etc.) + vision différenciation. Cocher `[x]` au fur et à mesure.
